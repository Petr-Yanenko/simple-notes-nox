...
main (int argc, char **argv)
{
  ...
  g_test_add ("/simple-notes-sqlite-controller/folders",
  ...
  g_test_add ("/simple-notes-sqlite-controller/notes",
              SimpleNotesSQLiteControllerFixture,
              NULL,
              simple_notes_sqlite_controller_fixture_set_up,
  ...
  g_test_add ("/simple-notes-folders-model/all",
  ...
  g_test_add ("/simple-notes-notes-model/all",
  ...
  g_test_add ("/simple-notes-content-model/all",
